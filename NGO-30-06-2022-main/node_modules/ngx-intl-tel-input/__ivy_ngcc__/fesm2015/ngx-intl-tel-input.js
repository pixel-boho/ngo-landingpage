import { PhoneNumberUtil, PhoneNumberFormat as PhoneNumberFormat$1 } from 'google-libphonenumber';
    ...
    */
    ...
    onPhoneNumberChange() {
        ...
        if (!this.value) {
            ...
            const intlNo = number
                ? this.phoneUtil.format(number, PhoneNumberFormat$1.INTERNATIONAL)
                : '';
            ...
            this.propagateChange({
                ...
                nationalNumber: number
                    ? this.phoneUtil.format(number, PhoneNumberFormat$1.NATIONAL)
                    : '',
                e164Number: number
                    ? this.phoneUtil.format(number, PhoneNumberFormat$1.E164)
                    : '',
    ...
    removeDialCode(phoneNumber) {
        ...
        phoneNumber = this.phoneUtil.format(number, PhoneNumberFormat$1[this.numberFormat]);
    ...
    getPhoneNumberPlaceHolder(countryCode) {
        try {
            return this.phoneUtil.format(this.phoneUtil.getExampleNumber(countryCode), PhoneNumberFormat$1[this.numberFormat]);
        }
        catch (e) {
            return e;
        }
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxIntlTelInputModule, { declarations: function () { return [NgxIntlTelInputComponent, NativeElementInjectorDirective]; }, imports: function () { return [CommonModule,
        FormsModule,
        ReactiveFormsModule, ɵngcc2.BsDropdownModule]; }, exports: function () { return [NgxIntlTelInputComponent, NativeElementInjectorDirective]; } }); })();
...
export { CountryISO, NativeElementInjectorDirective, NgxIntlTelInputComponent, NgxIntlTelInputModule, PhoneNumberFormat, SearchCountryField, dropdownModuleForRoot, ɵ0, CountryCode as ɵa, phoneNumberValidator as ɵb };
