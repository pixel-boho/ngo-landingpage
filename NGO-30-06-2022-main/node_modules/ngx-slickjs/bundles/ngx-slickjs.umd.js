(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('just-compare'), require('rxjs/operators'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('ngx-slickjs', ['@angular/core','exports', '@angular/core', 'just-compare', 'rxjs/operators', 'rxjs'], factory) :
    (global = global || self, factory(global.ng.core,global['ngx-slickjs'] = {}, global.ng.core, global.compare, global.rxjs.operators, global.rxjs));
}(this, function (ɵngcc0,exports, core, compare, operators, rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var LazyLoadService = /** @class */ (function () {
        ...
        function (url, type) {
            ...
            this._loadedLibraries[key] = new rxjs.ReplaySubject();
            /** @type {?} */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LazyLoadService, [{
    ...
    var SlickContainerDirective = /** @class */ (function () {
        ...
        function () {
             ...
             * @return {?}
             */
            function () { return 'jQuery is loaded'; })), operators.filter((/**
             * @param {?} jquery
             * @return {?}
             */
            function (jquery) { return !!jquery; })), operators.switchMap((/**
             * @return {?}
             */
            function () {
                return rxjs.forkJoin(_this.lazyLoadService.load(_this.links.slickJs, 'script'), _this.lazyLoadService.load(_this.links.slickCss, 'style'), _this.lazyLoadService.load(_this.links.slickThemeCss, 'style'));
            })), operators.take(1))
                .subscribe((/**
             * @return {?}
             */
        ...
        function () {
            ...
            if (this.config.mouseWheelMove === false)
                return;
            rxjs.fromEvent(this.elRef.nativeElement, 'wheel')
        ...
        SlickContainerDirective.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: ['slick-links',] }] }
        ]; };
        SlickContainerDirective.propDecorators = {
            config: [{ type: core.Input, args: ['slickConfig',] }],
            afterChange: [{ type: core.Output, args: ['slickAfterChange',] }],
            beforeChange: [{ type: core.Output, args: ['slickBeforeChange',] }],
            breakpoint: [{ type: core.Output, args: ['slickBreakpoint',] }],
            destroy: [{ type: core.Output, args: ['slickDestroy',] }],
            init: [{ type: core.Output, args: ['slickInit',] }]
        };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SlickContainerDirective, [{
    ...
    var SlickItemDirective = /** @class */ (function () {
        ...
        SlickItemDirective.ctorParameters = function () { return [
            { type: core.ElementRef },
            { type: SlickContainerDirective, decorators: [{ type: core.Host }] }
        ]; };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SlickItemDirective, [{
    ...
    /** @type {?} */
    var SLICK_LINKS = new core.InjectionToken("slick-links");
...
NgxSlickJsModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NgxSlickJsModule });
NgxSlickJsModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NgxSlickJsModule_Factory(t) { return new (t || NgxSlickJsModule)(); } });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxSlickJsModule, { declarations: [SlickContainerDirective, SlickItemDirective], exports: [SlickContainerDirective, SlickItemDirective] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgxSlickJsModule, [{
        type: core.NgModule,
        args: [{
    ...
    exports.NgxSlickJsModule = NgxSlickJsModule;
    exports.SLICK_LINKS = SLICK_LINKS;
    exports.SlickContainerDirective = SlickContainerDirective;
    exports.SlickItemDirective = SlickItemDirective;
    exports.linkOptionsFactory = linkOptionsFactory;
    exports.ɵa = SlickContainerDirective;
    exports.ɵb = LazyLoadService;
    exports.ɵd = SlickItemDirective;
    exports.ɵe = linkOptionsFactory;
    exports.ɵf = SLICK_LINKS;

    Object.defineProperty(exports, '__esModule', { value: true });

}));

//# sourceMappingURL=ngx-slickjs.umd.js.map