(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@angular/forms'),exports, require('@angular/common'), require('@angular/core'), require('hammerjs'), require('rxjs'), require('rxjs/operators'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('ngx-light-carousel', ['@angular/core','@angular/common','@angular/forms','exports', '@angular/common', '@angular/core', 'hammerjs', 'rxjs', 'rxjs/operators', '@angular/forms'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.ng.forms,global['ngx-light-carousel'] = {}, global.ng.common, global.ng.core, global.hammerjs, global.rxjs, global.rxjs.operators, global.ng.forms));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, common, core, hammerjs, rxjs, operators, forms) { 
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgxCarouselItemDirective, [{
    ...
    var NgxCarouselComponent = /** @class */ (function () {
        function NgxCarouselComponent(platformId, _renderer, zone) {
            ...
            this.subRef = this.throttleSub.pipe(operators.throttle(function (val) { return rxjs.interval(_this.options.animation.animationTime + 100); })).subscribe(function (data) {
                data();
            });
        }
        ...
        NgxCarouselComponent = __decorate([ __param(0, core.Inject(core.PLATFORM_ID)),
            __metadata("design:paramtypes", [Object, core.Renderer2, core.NgZone])
        ], NgxCarouselComponent);
NgxCarouselComponent.ɵfac = function NgxCarouselComponent_Factory(t) { return new (t || NgxCarouselComponent)(ɵngcc0.ɵɵdirectiveInject(core.PLATFORM_ID), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
NgxCarouselComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgxCarouselComponent, selectors: [["ngx-light-carousel"]], contentQueries: function NgxCarouselComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵcontentQuery(dirIndex, _c4, true, core.ViewContainerRef);
        ɵngcc0.ɵɵcontentQuery(dirIndex, _c5, true);
        ɵngcc0.ɵɵcontentQuery(dirIndex, NgxCarouselItemDirective, true, core.ElementRef);
    } if (rf & 2) {
        var _t;
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgxCarouselComponent, [{
        ...
        args: [{
            ...
            args: [NgxCarouselItemDirective, { read: core.ElementRef, descendants: true }]
        }], contentPrev: [{
            ...
            type: core.ContentChild,
            args: ['infiniteContainer', { static: false, read: core.ViewContainerRef }]
        }], contentContent: [{
            type: core.ContentChild,
...
NgxCarouselModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NgxCarouselModule_Factory(t) { return new (t || NgxCarouselModule)(); }, imports: [[common.CommonModule, forms.FormsModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxCarouselModule, { declarations: [NgxCarouselComponent, NgxCarouselItemDirective], imports: [ɵngcc1.CommonModule, ɵngcc2.FormsModule], exports: [NgxCarouselComponent, NgxCarouselItemDirective] }); })();
