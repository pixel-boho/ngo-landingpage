...
export declare class NgxExtendedPdfViewerComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
    ...
    private _scrollMode;
    get scrollMode(): ScrollModeType | undefined;
    set scrollMode(value: ScrollModeType | undefined);
    ...
    private _showSpreadButton;
    get showSpreadButton(): ResponsiveVisibility;
    set showSpreadButton(val: ResponsiveVisibility);
