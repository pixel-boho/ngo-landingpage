(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/platform-browser'),require('@angular/cdk/platform'),require('@angular/cdk/clipboard'),exports, require('@angular/core'), require('@angular/cdk/platform'), require('@angular/cdk/clipboard'), require('@angular/common'), require('@angular/platform-browser'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ngx-sharebuttons', ['@angular/core','@angular/platform-browser','@angular/cdk/platform','@angular/cdk/clipboard','exports', '@angular/core', '@angular/cdk/platform', '@angular/cdk/clipboard', '@angular/common', '@angular/platform-browser', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.platformBrowser,global.ng.cdk.platform,global.ng.cdk.clipboard,global['ngx-sharebuttons'] = {}, global.ng.core, global.ng.cdk.platform, global.ng.cdk.clipboard, global.ng.common, global.ng.platformBrowser, global.rxjs, global.rxjs.operators));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,exports, i0, platform, clipboard, i2, platformBrowser, rxjs, operators) { 'use strict';
...
ShareService.ɵfac = function ShareService_Factory(t) { return new (t || ShareService)(ɵngcc0.ɵɵinject(SHARE_BUTTONS_CONFIG, 8), ɵngcc0.ɵɵinject(i2.DOCUMENT)); };
...
ShareDirective.ɵfac = function ShareDirective_Factory(t) { return new (t || ShareDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.Meta), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.Platform), ɵngcc0.ɵɵdirectiveInject(ɵngcc3.Clipboard), ɵngcc0.ɵɵdirectiveInject(ShareService), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(i2.DOCUMENT)); };
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ShareModule, { declarations: [ShareDirective], imports: [ɵngcc2.PlatformModule, ɵngcc3.ClipboardModule], exports: [ShareDirective] }); })();
