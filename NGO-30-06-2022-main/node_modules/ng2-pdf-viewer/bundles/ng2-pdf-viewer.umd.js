(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('pdfjs-dist/es5/build/pdf'), require('pdfjs-dist/es5/web/pdf_viewer')) :
    typeof define === 'function' && define.amd ? define('ng2-pdf-viewer', ['@angular/core','exports', '@angular/core', 'rxjs', 'rxjs/operators', 'pdfjs-dist/es5/build/pdf', 'pdfjs-dist/es5/web/pdf_viewer'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global['ng2-pdf-viewer'] = {}, global.ng.core, global.rxjs, global.rxjs.operators, global.PDFJS, global.PDFJSViewer));
}(this, (function (ɵngcc0,exports, core, rxjs, operators, PDFJS, PDFJSViewer) { 
...
'use strict';
    ...
    var PdfViewerComponent = /** @class */ (function () {
        function PdfViewerComponent(element, ngZone) {
        ...
        PdfViewerComponent.prototype.initialize = function () {
            if (isSSR() || !this.isVisible) {
                return;
            }
        ...
        PdfViewerComponent.prototype.setupResizeListener = function () {
            var _this = this;
            if (isSSR()) {
                return;
            }
            this.ngZone.runOutsideAngular(function () {
                rxjs.fromEvent(window, 'resize')
                    .pipe(operators.debounceTime(100), operators.filter(function () { return _this._canAutoResize && !!_this._pdf; }), operators.takeUntil(_this.destroy$))
                    .subscribe(function () {
                    _this.updateSize();
                });
            });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PdfViewerModule, [{
        type: core.NgModule,
        args: [{
