...
@Component({
  selector: 'app-our-campaigns',
  templateUrl: './our-campaigns.component.html',
  styleUrls: ['./our-campaigns.component.css']
})
export class OurCampaignsComponent implements OnInit {
  ...
  showModal: boolean;
  campaignerlength: any;
  raisedAmountInPercentage: number;
  constructor(private fb: FormBuilder,private authService:AuthService,private router: Router,private spinner: NgxSpinnerService,private apiService: ApiService,private _formBuilder: FormBuilder ) {
  ...
  pageChanged(event){
    ...
    this.apiService.getCampaginerListByPagination(this.sorting,this.searchinput,this.category_id,event).subscribe((res:any)=>{
      ...
      console.log(this.campaignerList)
      this.category_idValue = [];
      this.baseUrl = res.baseUrl
      this.totalCount = res.totalCount;
      console.log(this.campaignerList[1]);
  ...
  getCampaigns(){
    ...
    this.apiService.getCampaginerList(this.sorting,this.searchinput,this.category_id).subscribe((res:any)=>{
      ...
      this.totalCount = res.totalCount;
     this.campaignerlength = this.campaignerList.length;
